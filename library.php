...
<html>
	...
	<body>
		...
		<!-- Modal -->
		<div class="modal fade" id="modal-room" role="dialog" data-page="room.html">
	    	<div class="modal-dialog modal-lg">
	      		<div class="modal-content">
	        		<div class="modal-header">
	          			<button type="button" class="close" data-dismiss="modal">&times;</button>
	          			<h4 class="modal-title">자리배치 세팅하기</h4>
	        		</div>
	  	...
	  	<div class="modal fade" id="modal-member" role="dialog" data-page="member.html">
	    	<div class="modal-dialog modal-lg">
	      		<div class="modal-content">
	        		<div class="modal-header">
	          			<button type="button" class="close" data-dismiss="modal">&times;</button>
	          			<h4 class="modal-title">회원 세팅하기</h4>
	        		</div>
	        		<div class="modal-body">
	          			<p>This is a large modal.</p>
	        		</div>
